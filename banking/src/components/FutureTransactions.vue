...
let futureTransactions = ref(Cookies.get("futureTransactions") ? JSON.parse(Cookies.get("futureTransactions")) : []);

</script>

<template>
  <div>
    <FutureTransactionLine v-for="transaction in futureTransactions" :key="transaction" :transaction="transaction" :futureTransactions="futureTransactions"/>
